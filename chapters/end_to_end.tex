...
and make sure they change appropriately. And try editing the AUTHOR in the \texttt{build.sh} file and make sure the right name shows up when the book is viewed in an eReader.
