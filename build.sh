...
if [[ $# -eq 0 ]]
   then
       ...
       ebook-convert ebookbook.html ebookbook.epub --cover images/cover.png --authors "$AUTHOR" --language English
       ebook-convert ebookbook.html ebookbook.mobi --cover images/cover.png --authors "$AUTHOR" --language English
...
# It removes all the output files known to be generated by pdflatex and htlatex.	
    ...
    rm -f "$MAINFILE"0x.png
    rm -f "$MAINFILE"-conversionLog.csv
    echo "Removing image bounding box (.xbb) files."
    rm -f images/*.xbb
